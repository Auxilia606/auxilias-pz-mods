...
$metadataFiles = @(
    ...
    (Join-Path $workshopRoot 'Contents\mods\AuxiliasQoL\mod.info'),
    (Join-Path $workshopRoot "Contents\mods\AuxiliasQoL\$gameReleaseLine\mod.info")
)
...
$archiveName = "AuxiliasQoL-$version.zip"
...
try {
    ...
    $requiredEntries = @(
        'workshop.txt',
        'preview.png',
        'Contents/mods/AuxiliasQoL/mod.info',
        "Contents/mods/AuxiliasQoL/$gameReleaseLine/mod.info"
    )
