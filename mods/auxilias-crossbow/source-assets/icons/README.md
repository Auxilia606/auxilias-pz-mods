...
The two broken-bolt icons depict only the recoverable head-side fragment at roughly seventy percent of the intact bolt's visual length. Each uses a compact asymmetric V-shaped break and one nearby wood chip; long fan-shaped splinters are avoided because they read as brown fletching after the runtime downsample.
