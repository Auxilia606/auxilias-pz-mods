...
$metadataFiles = @(
    ...
    (Join-Path $workshopRoot 'Contents\mods\AuxiliasAmmunition\mod.info'),
    (Join-Path $workshopRoot "Contents\mods\AuxiliasAmmunition\$gameReleaseLine\mod.info")
)
...
$archiveName = "AuxiliasAmmunition-$version.zip"
...
try {
    ...
    $requiredEntries = @(
        'workshop.txt',
        'preview.png',
        'Contents/mods/AuxiliasAmmunition/mod.info',
        "Contents/mods/AuxiliasAmmunition/$gameReleaseLine/mod.info"
    )
